...
class RssService {
  ...
  Future<List<Article>> fetchSource(NewsSource source) async {
  ...
  List<Article> _parseRss(String body, NewsSource source) {
  ...
  List<Article> _parseAtom(String body, NewsSource source) {
